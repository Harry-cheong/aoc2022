...
int main() {
    ...
    ifstream myFile("C:\\Users\\User\\Desktop\\Harry\\aoc2022\\aoc2022\\Day 5\\Part 2\\input.txt");
    ...
    int indexOfCrates[9] = {1, 5, 9, 13, 17, 21, 25, 29, 33};
        ...
        if (line < 9) {
            ...
            string transfer[noOfBox] = {};
            // Moving crates
            for (int i = 0; i < noOfBox; i++) {
                switch(initialStack) {
                    case 1:
                        transfer[i] = boxStack1.front();
                        boxStack1.pop_front();
                        break;
                    case 2:
                        transfer[i] = boxStack2.front();
                        boxStack2.pop_front();
                        break;
                    case 3:
                        transfer[i] = boxStack3.front();
                        boxStack3.pop_front();
                        break;
                    case 4:
                        transfer[i] = boxStack4.front();
                        boxStack4.pop_front();
                        break;
                    case 5:
                        transfer[i] = boxStack5.front();
                        boxStack5.pop_front();
                        break;
                    case 6:
                        transfer[i] = boxStack6.front();
                        boxStack6.pop_front();
                        break;
                    case 7:
                        transfer[i] = boxStack7.front();
                        boxStack7.pop_front();
                        break;
                    case 8:
                        transfer[i] = boxStack8.front();
                        boxStack8.pop_front();
                        break;
                    case 9:
                        transfer[i] = boxStack9.front();
                        boxStack9.pop_front();
                        break;
                }
            }

            for (int i = noOfBox - 1; i > -1; i--) {
                // cout << transfer << endl;
                switch(finalStack) {
                    case 1:
                        boxStack1.push_front(transfer[i]);
                        break;
                    case 2:
                        boxStack2.push_front(transfer[i]);
                        break;
                    case 3:
                        boxStack3.push_front(transfer[i]);
                        break;
                    case 4:
                        boxStack4.push_front(transfer[i]);
                        break;
                    case 5:
                        boxStack5.push_front(transfer[i]);
                        break;
                    case 6:
                        boxStack6.push_front(transfer[i]);
                        break;
                    case 7:
                        boxStack7.push_front(transfer[i]);
                        break;
                    case 8:
                        boxStack8.push_front(transfer[i]);
                        break;
                    case 9:
                        boxStack9.push_front(transfer[i]);
                        break;
                }
            }
        }
    ...
    cout << boxStack1.front() << boxStack2.front() <<boxStack3.front() << boxStack4.front() << boxStack5.front() << boxStack6.front() << boxStack7.front() << boxStack8.front() << boxStack9.front(); // Answer: GCFGLDNJZ
}